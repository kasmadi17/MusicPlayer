 ...
 * @date 11/09/20
 */
open class BaseSongFragment:Fragment(), OnPlayerActionCallback,
    OnPlayerServiceListener {

    private var mService: PlayerService? = null
    private var mBound = false
    val playerViewModel: PlayerViewModel = PlayerViewModel.getPlayerViewModelInstance()
    ...
    private val mConnection = object : ServiceConnection {
        ...
        override fun onServiceConnected(className: ComponentName, service: IBinder) {
            ...
            mService?.addListener(this@BaseSongFragment)
        }
    ...
    private fun bindPlayerService() {
        ...
        if (!mBound) requireContext().bindService(intent, mConnection, Context.BIND_AUTO_CREATE)
    }
